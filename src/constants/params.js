...
const baseTokenList = [
  ...
  },
  {
    ...
    "iconUrl": "https://assets.coingecko.com/coins/images/28173/small/wbtc-satoshi_D_3x.png?1696986732",
...
export const getAvailableTokensList = (chainId) => {
  let availableTokensList = [];
  switch (Number(chainId)) {
    case 8453:
      availableTokensList = [...networkTokenList, ...baseTokenList];
      break;
    case 1:
      availableTokensList = [...networkTokenList, ...ethereumTokenList];
      break;
    default:
      availableTokensList = [...networkTokenList, ...ethereumTokenList];
      break;
...
export const getTokenSymbolsForWalletBreakdown = (chainId) => {
  let tokenSymbols = [];
  switch (Number(chainId)) {
    case 8453:
      tokenSymbols = ['DAI', 'USDC', 'USDT', 'axlWBTC', 'WETH'];
      break;
    case 1:
      tokenSymbols = ['DAI', 'USDC', 'USDT', 'WBTC', 'WETH'];
      break;
    default:
      tokenSymbols = ['DAI', 'USDC', 'USDT', 'WBTC', 'WETH'];
      break;
