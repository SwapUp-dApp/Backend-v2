 ...
 * @property {string} SUBNAME_ACCESS_WALLET
 * @property {string} NAMESPACE_LISTED_ENS_NAME
 * @property {string} NAMESPACE_API_BASE_URL
 * @property {string} SWAPUP_TREASURY_SMART_ACCOUNT
 * @property {string} SWAPUP_TREASURY_PRIVATE_KEY
 ...
 * @property {string} AZURE_VAULT_NAME
 * @property {string} AZURE_VAULT_ENCRYPT_KEY_NAME
 * @property {string} AZURE_VAULT_CLIENT_ID
 * @property {string} AZURE_VAULT_TENANT_ID
 * @property {string} AZURE_VAULT_CLIENT_SECRET
 * @property {string} TREASURY_AZURE_VAULT_NAME
 * @property {string} TREASURY_AZURE_VAULT_SECRET_NAME
 * @property {string} ACCESS_CONTROL_ALLOWED_ORIGINS
 */
...
const config = {
  "local": {
    ...
    SWAPUP_TREASURY_PRIVATE_KEY: process.env.LOCAL_SWAPUP_TREASURY_PRIVATE_KEY,
    NAMESPACE_LISTED_ENS_NAME: process.env.LOCAL_NAMESPACE_LISTED_ENS_NAME,
    NAMESPACE_API_BASE_URL: process.env.LOCAL_NAMESPACE_API_BASE_URL,
    SUBNAME_ACCESS_WALLET: process.env.LOCAL_SUBNAME_ACCESS_WALLET,
    THIRDWEB_CLIENT_ID: process.env.LOCAL_THIRDWEB_CLIENT_ID,
    AZURE_VAULT_NAME: process.env.LOCAL_AZURE_VAULT_NAME || '',
    AZURE_VAULT_ENCRYPT_KEY_NAME: process.env.LOCAL_AZURE_VAULT_ENCRYPT_KEY_NAME || '',
    AZURE_VAULT_CLIENT_ID: process.env.LOCAL_AZURE_VAULT_CLIENT_ID || '',
    AZURE_VAULT_TENANT_ID: process.env.LOCAL_AZURE_VAULT_TENANT_ID || '',
    AZURE_VAULT_CLIENT_SECRET: process.env.LOCAL_AZURE_VAULT_CLIENT_SECRET || '',
    TREASURY_AZURE_VAULT_NAME: process.env.LOCAL_TREASURY_AZURE_VAULT_NAME || '',
    TREASURY_AZURE_VAULT_SECRET_NAME: process.env.LOCAL_TREASURY_AZURE_VAULT_SECRET_NAME || '',
    ACCESS_CONTROL_ALLOWED_ORIGINS: process.env.LOCAL_ACCESS_CONTROL_ALLOWED_ORIGINS || '',
  },
  ...
  "development": {
    ...
    NAMESPACE_LISTED_ENS_NAME: process.env.DEVELOPMENT_NAMESPACE_LISTED_ENS_NAME,
    NAMESPACE_API_BASE_URL: process.env.DEVELOPMENT_NAMESPACE_API_BASE_URL,
    SUBNAME_ACCESS_WALLET: process.env.DEVELOPMENT_SUBNAME_ACCESS_WALLET,
    ...
    SWAPUP_TREASURY_PRIVATE_KEY: process.env.DEVELOPMENT_SWAPUP_TREASURY_PRIVATE_KEY,
    THIRDWEB_CLIENT_ID: process.env.DEVELOPMENT_THIRDWEB_CLIENT_ID,
    AZURE_VAULT_NAME: process.env.DEVELOPMENT_AZURE_VAULT_NAME || '',
    AZURE_VAULT_ENCRYPT_KEY_NAME: process.env.DEVELOPMENT_AZURE_VAULT_ENCRYPT_KEY_NAME || '',
    AZURE_VAULT_CLIENT_ID: process.env.DEVELOPMENT_AZURE_VAULT_CLIENT_ID || '',
    AZURE_VAULT_TENANT_ID: process.env.DEVELOPMENT_AZURE_VAULT_TENANT_ID || '',
    AZURE_VAULT_CLIENT_SECRET: process.env.DEVELOPMENT_AZURE_VAULT_CLIENT_SECRET || '',
    TREASURY_AZURE_VAULT_NAME: process.env.DEVELOPMENT_TREASURY_AZURE_VAULT_NAME || '',
    TREASURY_AZURE_VAULT_SECRET_NAME: process.env.DEVELOPMENT_TREASURY_AZURE_VAULT_SECRET_NAME || '',
    ACCESS_CONTROL_ALLOWED_ORIGINS: process.env.DEVELOPMENT_ACCESS_CONTROL_ALLOWED_ORIGINS || '',
  },
  ...
  "staging": {
    ...
    NAMESPACE_LISTED_ENS_NAME: process.env.STAGING_NAMESPACE_LISTED_ENS_NAME,
    NAMESPACE_API_BASE_URL: process.env.STAGING_NAMESPACE_API_BASE_URL,
    SUBNAME_ACCESS_WALLET: process.env.STAGING_SUBNAME_ACCESS_WALLET,
    ...
    SWAPUP_TREASURY_PRIVATE_KEY: process.env.STAGING_SWAPUP_TREASURY_PRIVATE_KEY,
    THIRDWEB_CLIENT_ID: process.env.STAGING_THIRDWEB_CLIENT_ID,
    AZURE_VAULT_NAME: process.env.STAGING_AZURE_VAULT_NAME || '',
    AZURE_VAULT_ENCRYPT_KEY_NAME: process.env.STAGING_AZURE_VAULT_ENCRYPT_KEY_NAME || '',
    AZURE_VAULT_CLIENT_ID: process.env.STAGING_AZURE_VAULT_CLIENT_ID || '',
    AZURE_VAULT_TENANT_ID: process.env.STAGING_AZURE_VAULT_TENANT_ID || '',
    AZURE_VAULT_CLIENT_SECRET: process.env.STAGING_AZURE_VAULT_CLIENT_SECRET || '',
    TREASURY_AZURE_VAULT_NAME: process.env.STAGING_TREASURY_AZURE_VAULT_NAME || '',
    TREASURY_AZURE_VAULT_SECRET_NAME: process.env.STAGING_TREASURY_AZURE_VAULT_SECRET_NAME || '',
    ACCESS_CONTROL_ALLOWED_ORIGINS: process.env.STAGING_ACCESS_CONTROL_ALLOWED_ORIGINS || '',
  },
  ...
  "production": {
    ...
    NAMESPACE_LISTED_ENS_NAME: process.env.PRODUCTION_NAMESPACE_LISTED_ENS_NAME,
    NAMESPACE_API_BASE_URL: process.env.PRODUCTION_NAMESPACE_API_BASE_URL,
    SUBNAME_ACCESS_WALLET: process.env.PRODUCTION_SUBNAME_ACCESS_WALLET,
    ...
    SWAPUP_TREASURY_PRIVATE_KEY: process.env.PRODUCTION_SWAPUP_TREASURY_PRIVATE_KEY || '',
    THIRDWEB_CLIENT_ID: process.env.PRODUCTION_THIRDWEB_CLIENT_ID,
    AZURE_VAULT_NAME: process.env.PRODUCTION_AZURE_VAULT_NAME,
    AZURE_VAULT_ENCRYPT_KEY_NAME: process.env.PRODUCTION_AZURE_VAULT_ENCRYPT_KEY_NAME,
    AZURE_VAULT_CLIENT_ID: process.env.PRODUCTION_AZURE_VAULT_CLIENT_ID,
    AZURE_VAULT_TENANT_ID: process.env.PRODUCTION_AZURE_VAULT_TENANT_ID,
    AZURE_VAULT_CLIENT_SECRET: process.env.PRODUCTION_AZURE_VAULT_CLIENT_SECRET,
    TREASURY_AZURE_VAULT_NAME: process.env.PRODUCTION_TREASURY_AZURE_VAULT_NAME,
    TREASURY_AZURE_VAULT_SECRET_NAME: process.env.PRODUCTION_TREASURY_AZURE_VAULT_SECRET_NAME,
    ACCESS_CONTROL_ALLOWED_ORIGINS: process.env.PRODUCTION_ACCESS_CONTROL_ALLOWED_ORIGINS,
  },
};
